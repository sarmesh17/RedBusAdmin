...
@Composable
fun CustomButton(customButton: CustomButton, onButtonClick:() -> Unit) {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        Box (modifier = Modifier
            ...
            Row(modifier = Modifier
                .fillMaxWidth()
                .padding(top = 25.dp, start = 15.dp, end = 20.dp),
                horizontalArrangement = Arrangement.SpaceBetween,
                verticalAlignment = Alignment.CenterVertically) {
                Text(text = customButton.value, fontSize = 25.sp,
                    fontWeight = FontWeight.Bold, color = Color.White)

                Icon(painter = painterResource(id = R.drawable.rightarrow),
